...
- RCTs $`r Cite(myBib, c("Muriel2011"))`$
...
```{r p1-cont_conf, eval=T,  dev.args = list(bg = 'transparent'), echo=F, out.width= 350, warning=FALSE, include=T, paged.print=TRUE, fig.align="center", error=T, dpi=750, fig.showtext=T}
...
pagedown::chrome_print(gsub(".Rmd",".html",rstudioapi::getSourceEditorContext()$path),output="seminario.pdf")
xaringanBuilder::build_pdf(gsub(".Rmd",".Rmd",rstudioapi::getSourceEditorContext()$path),complex_slides = TRUE,output_file="seminario2.pdf")
```
