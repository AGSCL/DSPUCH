...
- **Estimación G**: La gran ventaja de esta herramienta es que puede usarse incluso cuando no hay “*common support*” (hay un nivel de confusión en que todos los participantes están expuestos o no expuestos y por tanto el supuesto de positividad peligra o *near-positivity violations*). Es muy sensible a la mala especificación, que llevará a estimaciones sesgadas mientras más etapas ($k$) se tenga. Por otra parte, es muy intensiva computacionalmente y requiere mayor programación y datos para resultados estables.
 
  Estandariza el riesgo de la distribución conjunta (*joint distribution*) de los confusores en todo el seguimiento densidad conjunta de los datos observados para generar resultados potenciales bajo distintos escenarios de resultados. Tiene la ventaja de que no asume una distribución paramétrica y por tanto es insensible a una eventual mala especificación. Los intervalos de confianza deben obtenerse mediante remuestreons de tipo *bootstrap*.
