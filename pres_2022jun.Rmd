...
output:
  xaringan::moon_reader:
    includes:
      after_body: ['libs/collapseoutput.js','libs/hideOutput.js', 'libs/zoom.html', 'libs/manualcollapseinput.html'] # collapse-output.html
    transition: slide
    lib_dir: libs
    css: ['libs/xaringan-themer.css', 'libs/animate.min.css', 'libs/ninjutsu', 'libs/my-theme.css']
...
.text_70[[Code available in: `r fontawesome::fa(name = "github")`](https://github.com/FONDECYTACC/SUD_health_Chile.github.io)]
...
+ Pareado con datos de fiscalía (~560,000 registros), para ~75.000 usuarios
...
- Note. Rel.= Relationships or the combination of a victim (Vic), an offender (Imp), a judicial cause (RUC).
